  ...
  return (
    <div className="text-light">
      <div className="respon">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?</p>
        <h4>How long do we keep tour information?</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga asperiores voluptatibus quidem dolores, quos officiis nostrum veritatis. A praesentium dicta temporibus vitae, excepturi sequi itaque? Pariatur veniam praesentium error qui necessitatibus. Et autem dolorum consectetur officia, provident quasi soluta?</p>
        ...
        <p>
          <ol>
            <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error, voluptas.</li>
            <li>Lorem ipsum dolor sit amet consectetur adipisicing.</li>
            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus voluptatem optio autem eveniet ab natus!</li>
          </ol>
        </p>
      ...
      <div>
        <hr />
        <img className='imgesbottoms' src={logos} />
        <span className="textbottoms">©2025 VideoTube. All rights reserved</span>
      </div>
    </div>
  )
